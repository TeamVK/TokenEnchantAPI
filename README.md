...
dependencies {
    ...
    compile group: 'com.vk2gpz.tokenenchant', name: 'TokenEnchantAPI', version: '18.7.1'
    // ... other dependencies
}
```
...
### [Extending EnchantHandler](https://github.com/TeamVK/TokenEnchantAPI/sample/TE-SampleEnchant)
